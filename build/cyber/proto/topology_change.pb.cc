...
void TableStruct::InitDefaultsImpl() {
  ...
  ::apollo::cyber::proto::protobuf_role_5fattributes_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  ::apollo::cyber::proto::protobuf_role_5fattributes_2eproto::AddDescriptors();
...
ChangeMsg::ChangeMsg()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_topology_5fchange_2eproto::InitDefaults();
  }
  SharedCtor();
