...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ShmConf, shm_type_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ShmConf, shm_locator_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ShmConf, use_async_read_),
  0,
  1,
  2,
  3,
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  ...
  { 9, 18, sizeof(ShmConf)},
  { 22, 31, sizeof(RtpsParticipantAttr)},
  { 35, 43, sizeof(CommunicationMode)},
  { 46, 52, sizeof(ResourceLimit)},
  { 53, 62, sizeof(TransportConf)},
};
...
ShmMulticastLocator::ShmMulticastLocator()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_transport_5fconf_2eproto::InitDefaults();
  }
  SharedCtor();
...
void ShmConf::SharedCtor() {
  ...
  notifier_type_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  shm_type_.UnsafeSetDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  ::memset(&shm_locator_, 0, reinterpret_cast<char*>(&use_async_read_) -
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->shm_type().data(), this->shm_type().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
...
void ShmConf::SerializeWithCachedSizes(
  ...
  if (cached_has_bits & 0x00000008u) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(4, this->use_async_read(), output);
  }
...
::google::protobuf::uint8* ShmConf::InternalSerializeWithCachedSizesToArray(
  ...
  // optional bool use_async_read = 4;
  if (cached_has_bits & 0x00000008u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(4, this->use_async_read(), target);
  }
...
void ShmConf::InternalSwap(ShmConf* other) {
  ...
  std::swap(use_async_read_, other->use_async_read_);
  std::swap(_has_bits_[0], other->_has_bits_[0]);
  _internal_metadata_.Swap(&other->_internal_metadata_);
  std::swap(_cached_size_, other->_cached_size_);
}
...
// optional string shm_type = 2;
bool ShmConf::has_shm_type() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void ShmConf::set_has_shm_type() {
  _has_bits_[0] |= 0x00000002u;
}
void ShmConf::clear_has_shm_type() {
  _has_bits_[0] &= ~0x00000002u;
}
void ShmConf::clear_shm_type() {
  shm_type_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_shm_type();
}
const ::std::string& ShmConf::shm_type() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.shm_type)
  return shm_type_.GetNoArena();
}
void ShmConf::set_shm_type(const ::std::string& value) {
  set_has_shm_type();
...
#if LANG_CXX11
void ShmConf::set_shm_type(::std::string&& value) {
  set_has_shm_type();
...
#endif
void ShmConf::set_shm_type(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_shm_type();
...
void ShmConf::set_shm_type(const char* value, size_t size) {
  set_has_shm_type();
...
::std::string* ShmConf::mutable_shm_type() {
  set_has_shm_type();
...
::std::string* ShmConf::release_shm_type() {
...
void ShmConf::set_allocated_shm_type(::std::string* shm_type) {
  if (shm_type != NULL) {
    set_has_shm_type();
  } else {
    clear_has_shm_type();
...
// optional bool use_async_read = 4;
bool ShmConf::has_use_async_read() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
void ShmConf::set_has_use_async_read() {
  _has_bits_[0] |= 0x00000008u;
}
void ShmConf::clear_has_use_async_read() {
  _has_bits_[0] &= ~0x00000008u;
}
void ShmConf::clear_use_async_read() {
  use_async_read_ = false;
  clear_has_use_async_read();
}
bool ShmConf::use_async_read() const {
  // @@protoc_insertion_point(field_get:apollo.cyber.proto.ShmConf.use_async_read)
  return use_async_read_;
}
void ShmConf::set_use_async_read(bool value) {
  set_has_use_async_read();
