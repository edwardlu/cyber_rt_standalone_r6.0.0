...
#include "cyber/examples/timer_send_component/timer_send_01.h"
#include "cyber/class_loader/class_loader.h"
#include "cyber/component/component.h"
#include "cyber/examples/proto/examples.pb.h"

bool TimerComponentSender_01::Init() {
	driver_writer_ = node_->CreateWriter<TestPackage>("/group_01/channel_01");
	return true;
}
